...
function displayLastAdded(sounds)
{
        ...
        for (let sound of sounds) {
            document.getElementById('thirdcontain').innerHTML += "<div class=\"soundprevlist\"><img alt=\"img\" class=\"Imgsec1\" src=" + sound.cover + "><div class=\"onhoversec1\"><div class=\"artistehover\">" + sound.titre + "</div><div class=\"titrehover\">" + sound.date_parution + "</div></div><div class=\"lientitre\">" + sound.emplacement_morceau + "</div><div class=\"titremorceau\">" + sound.titre+ "</div></div>";
        }
